...
const Create = () => {
  ...
  return (
    <div className="mx-auto w-[90%] pt-32 bg-white dark:bg-secondary" id="Create">
      ...
      <div className="flex items-center rounded-xl mb-3 border-2 border-secondary bg-[linear-gradient(115deg,_rgba(255,255,255,0)_10%,_rgba(0,255,165,.5),_rgba(0,255,165,1))] shadow-[0px_0px_7px_2px] shadow-primary sm:h-[400px]">
        <div className="flex flex-col justify-between p-10 sm:flex-row sm:items-center sm:px-10 sm:py-5 lg:px-24 lg:py-5">
          ...
          <div className="text-secondary sm:flex sm:w-1/2 sm:flex-col sm:items-end">
            <div className="sm:w-[35vw] md:w-[30vw] lg:w-[20vw]">
              <Reveal>
                <h1 className="m-2 my-3 text-center font-dosis text-[27px] font-bold text-secondary dark:text-white sm:text-4xl">
                  Let&#39;s
            ...
            <Reveal>
              ...
              >
                ...
                students can complete from anywhere.
              </p>
            </Reveal>
